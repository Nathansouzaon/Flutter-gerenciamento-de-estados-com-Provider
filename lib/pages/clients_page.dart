...
class _ClientsPageState extends State<ClientsPage> {
          ...
          itemBuilder: (context, index) {
            return Dismissible(
              ...
              onDismissed: (direction) {
                  list.remove(index);//usando meu metodo remove 
                  //não precisa do setState pois meu notifyListeners gera notificação de que algo mudou
            },
          );
        },
      );
        }
      ),//o consumer esta se referenciando com o tipo Client
  ...
  void createType(context) {
    ...
    Types listTypes = Provider.of<Types>(context, listen: false);//pegamos listTypes vindo la do estado o listen false se colocar true fica ouvindo alterações
    ClientType dropdownValue = listTypes.types[0];//vai pegar o primeiro item da lista clients
                      ...
                      children: <Widget>[
                        ...
                        StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
                          return DropdownButton(
                            ...
                            //vai fazer um map desses valores
